 ...
 */
public class AutonomousArcadeDrivePiDist extends Command {
    ...
    public AutonomousArcadeDrivePiDist(double encoderCount, double timeoutSeconds) {
    ...
    protected void initialize() {
    	m_encoderCount = (SmartDashboard.getNumber("piDistance", 20.0)) * Robot.drives.encodersPerInch;
    ...
    protected void execute() {
    	SmartDashboard.putString("AutoState", "StraightAgain");
    ...
    protected void end() {
    	SmartDashboard.putString("AutoState", "DoneStraightAgain");
