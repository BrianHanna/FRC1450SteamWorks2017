...
public class AutonomousArcadeDrive extends Command {
    ...
    public AutonomousArcadeDrive(double encoderCount, double timeoutSeconds) {
    ...
    protected boolean isFinished() {
    	...
    	return (
    			(Math.abs((-1 * m_encoderCount) - Robot.drives.GetLeftPosition()) < (Robot.drives.encodersPerInch * 3)) ||
    			(Math.abs(m_encoderCount - Robot.drives.GetRightPosition()) < (Robot.drives.encodersPerInch * 3)) ||
