...
public class leftHookAutonomousCommandGroup extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        ...
        addSequential(new driveForwardEncoderCount((60.0) * Robot.drives.encodersPerInch,8));
        addSequential(new turnRight(-60.0, 3.0));
        addSequential(new driveForwardEncoderCount((24.0) * Robot.drives.encodersPerInch, 4.0));
